...
public class Pile6RankController extends java.awt.event.MouseAdapter{
	/** The Intrigue Game. */
	 ...
	 */
	public Pile6RankController(Intrigue theGame, PileView pile6Rank) {
		super();
	...
	public void mouseReleased(MouseEvent me) {
		...
		Pile pile6Rank = (Pile) src.getModelElement();
		Column columnSource = (Column) fromWidget.getModelElement();
		
		CardView cardView = (CardView) draggingWidget;
		Card theCard = (Card) cardView.getModelElement();
		
		Move move = new MoveCardTo6RankPile(columnSource,pile6Rank,theCard);
